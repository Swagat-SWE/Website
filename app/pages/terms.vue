    ...
    <main class="main">
      ...
      <section class="section">
        ...
        <div class="policyContent">
          <p>
            These Terms of Use govern your access to and use of the website and services provided by
            Einstein Bros. By accessing or using the Site, you agree to be bound by these Terms. If
      ...
      <section class="section">
        ...
        <div class="policyContent">
          <p>
            All content on the Site, including text, images, logos, and software, is the property of
            Einstein Bros or its licensors and is protected by intellectual property laws. You may
            not copy, reproduce, or create derivative works without prior written permission.
          </p>
        </div>
      </section>
      ...
      <section class="section">
        ...
        <div class="policyContent">
          <p>
            The Site may contain links or integrations with third-party services. We are not
            responsible for the availability or practices of those services.
          </p>
        </div>
      </section>
      ...
      <section class="section">
        ...
        <div class="policyContent">
          <p>
            TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, EINSTEIN BROS SHALL NOT BE LIABLE FOR
      ...
      <section class="section">
        ...
        <div class="policyContent">
          <p>
            ...
            business reasons, without liability to you.
          </p>
        </div>
      </section>
      ...
      <section class="section">
        ...
        <div class="policyContent">
          <p>
            These Terms are governed by the laws of the State of Iowa, without regard to conflict of
            law principles.
          </p>
        </div>
      </section>
      ...
      <section class="section">
        ...
        <div class="policyContent">
          <p>
            ...
            updated "Last updated" date. Continued use after changes constitutes acceptance of the
            new Terms.
          </p>
        </div>
      </section>
      ...
      <!-- Slide-out cart panel (optional placeholder) -->
...
/* Cart slide-over (optional placeholder) */
.overlay {
  position: fixed;
  inset: 0;
